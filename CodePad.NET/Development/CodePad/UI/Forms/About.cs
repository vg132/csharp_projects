...
namespace VGSoftware.CodePad.UI.Forms
{
	partial class About : Form
	{
		public About()
		{
			...
			productVersionLabel.Text = string.Format("Version {0}", AssemblyVersion);
		...
		private void webPageLinkLabel_Click(object sender, EventArgs e)
		{
			System.Diagnostics.Process.Start("http://codepadnet.codeplex.com/");
		}
