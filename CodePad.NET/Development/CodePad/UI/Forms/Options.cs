...
namespace VGSoftware.CodePad.UI.Forms
{
	public partial class Options : Form
	{
		...
		{
			indentStyleComboBox.SelectedItem = Enum.GetName(typeof(ICSharpCode.TextEditor.Document.IndentStyle), Properties.Settings.Default.TextEditor_IndentStyle);
			showTabCheckBox.Checked = Properties.Settings.Default.TextEditor_ShowTabs;
			showSpacesCheckBox.Checked = Properties.Settings.Default.TextEditor_ShowSpaces;
			showEndOfLineCheckBox.Checked = Properties.Settings.Default.TextEditor_ShowEndOfLine;
			showLineNumbersCheckBox.Checked = Properties.Settings.Default.TextEditor_ShowLineNumbers;
			highlightSelectedLineCheckBox.Checked = Properties.Settings.Default.TextEditor_HighlightSelectedLine;
			tabSizeTextBox.Text = Properties.Settings.Default.TextEditor_TabSize.ToString();
			if (Properties.Settings.Default.TextEditor_KeepTabs)
			{
		...
		{
			Properties.Settings.Default.TextEditor_IndentStyle = (ICSharpCode.TextEditor.Document.IndentStyle)Enum.Parse(typeof(ICSharpCode.TextEditor.Document.IndentStyle), Convert.ToString(indentStyleComboBox.SelectedItem));
			Properties.Settings.Default.TextEditor_ShowTabs = showTabCheckBox.Checked;
			Properties.Settings.Default.TextEditor_ShowSpaces = showSpacesCheckBox.Checked;
			Properties.Settings.Default.TextEditor_ShowEndOfLine = showEndOfLineCheckBox.Checked;
			Properties.Settings.Default.TextEditor_ShowLineNumbers = showLineNumbersCheckBox.Checked;
			Properties.Settings.Default.TextEditor_HighlightSelectedLine = highlightSelectedLineCheckBox.Checked;
			Properties.Settings.Default.TextEditor_TabSize = Convert.ToInt32(tabSizeTextBox.Text);
			Properties.Settings.Default.TextEditor_KeepTabs = keepTabsRadioButton.Checked;
		}
